...
bool ros2_data__msg__joint_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_data.msg._joint_pose.JointPose", full_classname_dest, 35) == 0);
  }
  ros2_data__msg__JointPose * ros_message = _ros_message;
  {  // joint1
...
PyObject * ros2_data__msg__joint_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_data.msg._joint_pose");
