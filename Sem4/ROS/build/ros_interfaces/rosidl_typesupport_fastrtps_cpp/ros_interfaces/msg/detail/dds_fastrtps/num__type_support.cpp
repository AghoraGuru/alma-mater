...
#include "ros_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_interfaces::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_interfaces::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
...
{
  auto typed_message =
    static_cast<const ros_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  return &ros_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_interfaces, msg, Num)() {
  return &ros_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
