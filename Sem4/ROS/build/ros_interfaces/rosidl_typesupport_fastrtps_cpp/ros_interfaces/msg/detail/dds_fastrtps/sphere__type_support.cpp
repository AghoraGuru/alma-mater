...
#include "ros_interfaces/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_interfaces::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_interfaces::msg::Sphere & ros_message)
{
  // Member: center
...
{
  auto typed_message =
    static_cast<const ros_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &ros_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_interfaces, msg, Sphere)() {
  return &ros_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
