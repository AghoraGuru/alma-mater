...
ros_interfaces__srv__AddTreeInts_Request__create()
{
  ...
  ros_interfaces__srv__AddTreeInts_Request * msg = (ros_interfaces__srv__AddTreeInts_Request *)allocator.allocate(sizeof(ros_interfaces__srv__AddTreeInts_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros_interfaces__srv__AddTreeInts_Request));
  bool success = ros_interfaces__srv__AddTreeInts_Request__init(msg);
  if (!success) {
...
ros_interfaces__srv__AddTreeInts_Request__destroy(ros_interfaces__srv__AddTreeInts_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ros_interfaces__srv__AddTreeInts_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ros_interfaces__srv__AddTreeInts_Request__Sequence__init(ros_interfaces__srv__AddTreeInts_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_interfaces__srv__AddTreeInts_Request * data = NULL;

  if (size) {
    data = (ros_interfaces__srv__AddTreeInts_Request *)allocator.zero_allocate(size, sizeof(ros_interfaces__srv__AddTreeInts_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros_interfaces__srv__AddTreeInts_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros_interfaces__srv__AddTreeInts_Request__fini(&data[i - 1]);
      }
...
ros_interfaces__srv__AddTreeInts_Request__Sequence__fini(ros_interfaces__srv__AddTreeInts_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros_interfaces__srv__AddTreeInts_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_interfaces__srv__AddTreeInts_Request__Sequence * array = (ros_interfaces__srv__AddTreeInts_Request__Sequence *)allocator.allocate(sizeof(ros_interfaces__srv__AddTreeInts_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros_interfaces__srv__AddTreeInts_Request__Sequence__init(array, size);
  if (!success) {
...
ros_interfaces__srv__AddTreeInts_Request__Sequence__destroy(ros_interfaces__srv__AddTreeInts_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros_interfaces__srv__AddTreeInts_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros_interfaces__srv__AddTreeInts_Request__Sequence__are_equal(const ros_interfaces__srv__AddTreeInts_Request__Sequence * lhs, const ros_interfaces__srv__AddTreeInts_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros_interfaces__srv__AddTreeInts_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros_interfaces__srv__AddTreeInts_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros_interfaces__srv__AddTreeInts_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros_interfaces__srv__AddTreeInts_Request * data =
      (ros_interfaces__srv__AddTreeInts_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_interfaces__srv__AddTreeInts_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros_interfaces__srv__AddTreeInts_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros_interfaces__srv__AddTreeInts_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_interfaces__srv__AddTreeInts_Response * msg = (ros_interfaces__srv__AddTreeInts_Response *)allocator.allocate(sizeof(ros_interfaces__srv__AddTreeInts_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros_interfaces__srv__AddTreeInts_Response));
  bool success = ros_interfaces__srv__AddTreeInts_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros_interfaces__srv__AddTreeInts_Response__destroy(ros_interfaces__srv__AddTreeInts_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ros_interfaces__srv__AddTreeInts_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ros_interfaces__srv__AddTreeInts_Response__Sequence__init(ros_interfaces__srv__AddTreeInts_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_interfaces__srv__AddTreeInts_Response * data = NULL;

  if (size) {
    data = (ros_interfaces__srv__AddTreeInts_Response *)allocator.zero_allocate(size, sizeof(ros_interfaces__srv__AddTreeInts_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros_interfaces__srv__AddTreeInts_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros_interfaces__srv__AddTreeInts_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros_interfaces__srv__AddTreeInts_Response__Sequence__fini(ros_interfaces__srv__AddTreeInts_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros_interfaces__srv__AddTreeInts_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_interfaces__srv__AddTreeInts_Response__Sequence * array = (ros_interfaces__srv__AddTreeInts_Response__Sequence *)allocator.allocate(sizeof(ros_interfaces__srv__AddTreeInts_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros_interfaces__srv__AddTreeInts_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros_interfaces__srv__AddTreeInts_Response__Sequence__destroy(ros_interfaces__srv__AddTreeInts_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros_interfaces__srv__AddTreeInts_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros_interfaces__srv__AddTreeInts_Response__Sequence__are_equal(const ros_interfaces__srv__AddTreeInts_Response__Sequence * lhs, const ros_interfaces__srv__AddTreeInts_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros_interfaces__srv__AddTreeInts_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros_interfaces__srv__AddTreeInts_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros_interfaces__srv__AddTreeInts_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros_interfaces__srv__AddTreeInts_Response * data =
      (ros_interfaces__srv__AddTreeInts_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_interfaces__srv__AddTreeInts_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros_interfaces__srv__AddTreeInts_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros_interfaces__srv__AddTreeInts_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
