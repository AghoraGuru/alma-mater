  ...
  ros2_data__action__MoveJ_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ros2_data__action__MoveJ_Goal * data =
      (ros2_data__action__MoveJ_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_data__action__MoveJ_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_data__action__MoveJ_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  ros2_data__action__MoveJ_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ros2_data__action__MoveJ_Result * data =
      (ros2_data__action__MoveJ_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_data__action__MoveJ_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_data__action__MoveJ_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  ros2_data__action__MoveJ_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ros2_data__action__MoveJ_Feedback * data =
      (ros2_data__action__MoveJ_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_data__action__MoveJ_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_data__action__MoveJ_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  ros2_data__action__MoveJ_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ros2_data__action__MoveJ_SendGoal_Request * data =
      (ros2_data__action__MoveJ_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_data__action__MoveJ_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_data__action__MoveJ_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  ros2_data__action__MoveJ_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ros2_data__action__MoveJ_SendGoal_Response * data =
      (ros2_data__action__MoveJ_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_data__action__MoveJ_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_data__action__MoveJ_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  ros2_data__action__MoveJ_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ros2_data__action__MoveJ_GetResult_Request * data =
      (ros2_data__action__MoveJ_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_data__action__MoveJ_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_data__action__MoveJ_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  ros2_data__action__MoveJ_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ros2_data__action__MoveJ_GetResult_Response * data =
      (ros2_data__action__MoveJ_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_data__action__MoveJ_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_data__action__MoveJ_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  ros2_data__action__MoveJ_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ros2_data__action__MoveJ_FeedbackMessage * data =
      (ros2_data__action__MoveJ_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_data__action__MoveJ_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_data__action__MoveJ_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
